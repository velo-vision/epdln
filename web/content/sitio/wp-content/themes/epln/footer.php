                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        ...
                        <ul class="socialfooter">
                            ...
                            <li><a href="" class="twitter  hvr-float"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            <li><a href="" class="youtube  hvr-float"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
